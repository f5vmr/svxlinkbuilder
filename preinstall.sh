#/bin/bash
    ...
    sudo wget -O /var/cache/apt/archives/svxlink-25.5.1.gb89468d3-Linux.deb \
    https://github.com/f5vmr/svxlink/releases/download/V25.5/svxlink-25.5.1.gb89468d3-Linux.deb
    sudo apt install /var/cache/apt/archives/svxlink-25.5.1.gb89468d3-Linux.deb -y

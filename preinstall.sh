#/bin/bash
    ...
    sudo wget -O /var/cache/apt/archives/svxlink-master-Linux.deb \
    https://github.com/f5vmr/svxlink/releases/download/V25.5/svxlink-master-Linux.deb
    sudo apt install /var/cache/apt/archives/svxlink-master-Linux.deb -y

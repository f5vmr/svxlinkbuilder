...
<p>Cette version contient désormais un délai d'expiration automatique de trois minutes pour les utilisateurs RF. Il s'agit d'éduquer les utilisateurs pour éviter que leur discours ne soit trop long.</p>
<p>Ce mécanisme de temporisation ne bloque pas l'utilisateur pendant qu'il parle, mais superpose une série de pip-tones à l'émission, qui se terminent lorsque l'orateur relâche le PTT. Le mécanisme de silencieux détecte cela et envoie verbalement un « Time-out » sur la transmission, avant d'émettre un « K » pour une utilisation continue du répéteur.</p>
